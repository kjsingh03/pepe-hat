  ...
  return (
    <>
      <div className="h-[100vh] overflow-y-auto">
        <div className='h-screen z-40 bg-[url(./assets/bg1.webp)] bg-no-repeat bg-center bg-cover bg-fixed flex items-center justify-center'>
...

            {
              ...
              <>
                <div ref={screenRef} className='screen z-50 w-screen h-screen fixed left-0 top-0 flex flex-col gap-4 items-center justify-center backdrop-blur-sm'>
                  <div className="modal flex flex-col gap-4 items-center justify-center mx-auto p-5 w-full xs:w-[70vw] sm:w-[50vw] 2xl:w-[40vw] h-[20rem]">
